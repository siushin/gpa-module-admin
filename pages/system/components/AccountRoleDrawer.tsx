...
interface AccountRoleDrawerProps {
  visible: boolean;
  record: any;
  onClose: () => void;
  onSuccess?: () => void;
...
const AccountRoleDrawer: React.FC<AccountRoleDrawerProps> = ({
  visible,
  record,
  onClose,
  onSuccess,
  ...
  const loadRoles = async () => {
    ...
    setLoading(true);
    try {
      const res = await getAdminRoles({ account_id: record.account_id });
...
export default AccountRoleDrawer;
